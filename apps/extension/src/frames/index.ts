...
export { FRAME_BUDGET, FRAME_MARK, FRAME_MAX_INDENT, FRAME_MAX_LINES, FRAME_SHADOW_DEPTH, FRAME_VERSION, frameElements, frameNumber, isFrameMessage, stamp } from './protocol';
