...
- <notes> are facts from pages the user read recently in other tabs, each one dated. When the field is clearly asking for one of them, use it, and prefer a recent one.
