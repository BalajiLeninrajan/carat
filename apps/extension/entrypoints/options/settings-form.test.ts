...
const base = { enabled: true, provider: 'openai', baseURL: '', apiKey: '', model: '', statusLine: false, sound: true, smartModel: '', screenshots: false, eagerness: 'eager', ghost: true, evidence: 'debugger' };
